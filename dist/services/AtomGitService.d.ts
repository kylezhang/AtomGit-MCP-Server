...
export declare class AtomGitService {
    ...
    getOauthToken(code: string, clientId: string, clientSecret: string): Promise<any>;
    removeOrganizationTeamMember(org: string, team: string, username: string): Promise<void>;
    getRepositoryCommitsStats(owner: string, repo: string, sha?: string): Promise<any>;
    getRepositoryCommitsActivity(owner: string, repo: string, sha?: string): Promise<any>;
    getRepositoryCodeFrequency(owner: string, repo: string, sha?: string): Promise<any>;
    getRepositoryWeekCount(owner: string, repo: string): Promise<any>;
    getRepositoryHourlyCommits(owner: string, repo: string): Promise<any>;
    getEnterpriseProject(enterprise: string, project: string): Promise<any>;
    updateEnterpriseProject(enterprise: string, project: string, projectData: any): Promise<any>;
    deleteEnterpriseProject(enterprise: string, project: string): Promise<void>;
    getEnterpriseTeams(enterprise: string): Promise<any[]>;
    getEnterpriseTeam(enterprise: string, team: string): Promise<any>;
    createEnterpriseTeam(enterprise: string, teamData: any): Promise<any>;
    updateEnterpriseTeam(enterprise: string, team: string, teamData: any): Promise<any>;
    deleteEnterpriseTeam(enterprise: string, team: string): Promise<void>;
    getEnterpriseTeamMembers(enterprise: string, team: string): Promise<any[]>;
    addEnterpriseTeamMember(enterprise: string, team: string, username: string, memberData: any): Promise<any>;
    removeEnterpriseTeamMember(enterprise: string, team: string, username: string): Promise<void>;
    pingRepositoryWebhook(owner: string, repo: string, id: number): Promise<any>;
    addOrganizationKanbanCard(owner: string, id: string, cardData: any): Promise<any>;
    updateOrganizationKanbanCard(owner: string, id: string, cardData: any): Promise<any>;
    deleteOrganizationKanbanCard(owner: string, id: string): Promise<void>;
}
