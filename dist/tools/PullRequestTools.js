    ...
    async callTool(name, args) {
        switch (name) {
            case 'get_repository_pulls':
                return await this.pullRequestService.getRepositoryPulls(args.owner, args.repo, args.state, args.page, args.perPage);
            ...
            case 'get_repository_pull_comments':
                return await this.pullRequestService.getRepositoryPullComments(args.owner, args.repo, args.pullNumber, args.page, args.perPage);
            case 'get_repository_pull_files':
                return await this.pullRequestService.getRepositoryPullFiles(args.owner, args.repo, args.pullNumber, args.page, args.perPage);
            ...
            case 'get_repository_pull_labels':
                return await this.pullRequestService.getRepositoryPullLabels(args.owner, args.repo, args.pullNumber);
