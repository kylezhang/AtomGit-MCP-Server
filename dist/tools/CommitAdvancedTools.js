    ...
    async callTool(name, args) {
        switch (name) {
            case 'get_repository_commit_comments':
                return await this.atomGitService.getRepositoryCommitComments(args.owner, args.repo, args.sha, args.page, args.perPage);
...
//# sourceMappingURL=CommitAdvancedTools.js.map