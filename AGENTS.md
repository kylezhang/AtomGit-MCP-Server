...
- Public tools are fully mapped in [docs/api_tool_map.md](./docs/api_tool_map.md) (auto-generated, always in sync)
- Tools organized by module categories (see the same map)
